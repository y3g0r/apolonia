...
namespace DiskUsageAnalyzer
{
	...
	public class FolderAnalyzer
	{
        ...
        //Calculates the size in bytes of a folder content.
		private static long CalculateSize( DirectoryInfo info )
		{
            ...
            {
                Console.WriteLine("***EXCEPTION RAISED*** with message: ");
		...
		public void CalculateDisk(FolderItem root)
		{
            ...
            if (level > FolderItem.maxLevel) return;
			...
			if( root.SweepAngle > CircleMap.minAngle )
